import { f as fallback, b as bind_props, a as attr, e as ensure_array_like, s as sanitize_props, c as store_get, d as attr_class, g as clsx, h as attr_style, i as spread_props, j as slot, k as escape_html, u as unsubscribe_stores, r as rest_props, l as attributes } from "../../chunks/index.js";
...
function Toaster($$renderer, $$props) {
  ...
  $$renderer.component(($$renderer2) => {
    ...
    if (store_get($$store_subs ??= {}, "$toasts", toasts).length > 0) {
      $$renderer2.push("<!--[0-->");
      $$renderer2.push(`<section${attr("aria-label", `${containerAriaLabel} ${hotkeyLabel}`)}${attr("tabindex", -1)} class="svelte-10eolot"><!--[-->`);
...
function _layout($$renderer, $$props) {
  Toaster($$renderer, { position: "top-right", richColors: true });
  $$renderer.push(`<!----> <!--[-->`);
